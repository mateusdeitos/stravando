					...
					<Flex direction="column" alignItems="center" pos="absolute" w="75%" h="85%" top="50%" left="50%" transform="translate(-50%, -50%)">
						{session ? (
							...
							<>
								...
								{!isWideVersion && <Spacer />}
								<Link href="/stats/demo"><Button as="a" cursor="pointer" leftIcon={<Icon as={FaChartLine} />} mt="6" minW="20rem" minH="3rem" colorScheme="orange" data-gtm="ver-demo">Ver uma demonstração</Button></Link>
								{!isWideVersion && <Button leftIcon={<Icon as={FaStrava} />} mt="1rem" minW="20rem" minH="3rem" colorScheme="orange" data-gtm="conectar-strava"  isLoading={loadingSignIn} onClick={() => { setLoadingSignIn(true); handleSignIn(); }} >Conectar no Strava</Button>}
							</>
						)}
					</Flex>
				</Box>
